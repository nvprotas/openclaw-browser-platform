...
- [ ] корзина открывается
- [ ] checkout entry / payment boundary достигается без финального submit
- [ ] если появляется SberPay intent, его идентификаторы извлекаются и сохраняются в trace / structured output
